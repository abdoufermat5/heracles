...
class PermissionResponse(BaseModel):
    ...
    plugin: str | None = Field(None, description="Plugin that defines this permission (null=core)")
...
class AttributeGroupResponse(BaseModel):
    ...
    plugin: str | None = Field(None, description="Plugin that defines this group (null=core)")
...
class PolicyCreate(BaseModel):
    ...
    description: str | None = Field(None, max_length=1024, description="Policy description")
...
class PolicyUpdate(BaseModel):
    ...
    name: str | None = Field(None, min_length=1, max_length=128, description="Policy name")
    description: str | None = Field(None, max_length=1024, description="Policy description")
    permissions: list[str] | None = Field(None, description="List of permission names")
...
class AssignmentCreate(BaseModel):
    ...
    scope_dn: str | None = Field("", alias="scopeDn", description="Scope DN (empty=global)")
    scope_type: str | None = Field("subtree", alias="scopeType", pattern="^(base|subtree)$", description="Scope type")
    self_only: bool | None = Field(False, alias="selfOnly", description="Only applies to own entry")
    deny: bool | None = Field(False, description="Deny (negate) permissions")
    priority: int | None = Field(0, ge=0, le=1000, description="Priority")
...
class AssignmentUpdate(BaseModel):
    ...
    scope_dn: str | None = Field(None, alias="scopeDn", description="Scope DN (empty=global)")
    scope_type: str | None = Field(None, alias="scopeType", pattern="^(base|subtree)$", description="Scope type")
    self_only: bool | None = Field(None, alias="selfOnly", description="Only applies to own entry")
    deny: bool | None = Field(None, description="Deny (negate) permissions")
    priority: int | None = Field(None, ge=0, le=1000, description="Priority")
...
class PolicyDetailResponse(BaseModel):
    ...
    permissions: list[str] = Field(..., description="List of permission names (scope:action)")
    builtin: bool = Field(..., description="Whether this is a built-in policy")
    attr_rules: list[PolicyAttrRuleResponse] = Field(
        default_factory=list, alias="attrRules", description="Attribute rules"
    )
    created_at: datetime = Field(..., alias="createdAt", description="Creation timestamp")
    updated_at: datetime = Field(..., alias="updatedAt", description="Last update timestamp")
...
class AuditLogEntry(BaseModel):
    ...
    target_dn: str | None = Field(None, alias="targetDn", description="Target DN")
    permission: str | None = Field(None, description="Permission checked")
    result: bool | None = Field(None, description="Check result (allowed/denied)")
