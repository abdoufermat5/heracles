...
class PluginRegistry:
    ...
    def unregister(self, name: str) -> None:
        ...
        for tab in plugin.tabs():
            if tab.object_type in self._tabs_by_object_type:
                self._tabs_by_object_type[tab.object_type] = [
                    t for t in self._tabs_by_object_type[tab.object_type] if t.id != tab.id
                ]
    ...
    def get_service(self, tab_id: str) -> TabService | None:
    ...
    def get_import_fields_for_type(self, object_type: str) -> list[PluginFieldDefinition]:
        """
    ...
    def get_export_fields_for_type(self, object_type: str) -> list[PluginFieldDefinition]:
    ...
    def get_template_fields_for_type(self, object_type: str) -> dict[str, Any]:
        """
