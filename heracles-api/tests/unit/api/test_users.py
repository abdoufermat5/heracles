...
class TestListUsers:
    ...
    def test_list_users_with_results(self, test_client, auth_headers, mock_user_repository, user_entry_factory):
    ...
    def test_list_users_with_search(self, test_client, auth_headers, mock_user_repository, user_entry_factory):
        ...
        response = test_client.get("/api/v1/users/", params={"search": "john"}, headers=auth_headers)

        assert response.status_code == 200
        mock_user_repository.search.assert_called_once()

    def test_list_users_pagination(self, test_client, auth_headers, mock_user_repository, user_entry_factory):
        ...
        response = test_client.get("/api/v1/users/", params={"page": 1, "page_size": 10}, headers=auth_headers)
...
class TestGetUser:
    ...
    def test_get_user_success(self, test_client, auth_headers, mock_user_repository, mock_user_entry):
...
class TestCreateUser:
    ...
    def test_create_user_success(self, test_client, auth_headers, mock_user_repository, mock_user_entry):
    ...
    def test_create_user_already_exists(self, test_client, auth_headers, mock_user_repository, mock_user_entry):
...
class TestUpdateUser:
    ...
    def test_update_user_success(self, test_client, auth_headers, mock_user_repository, mock_user_entry):
        ...
        response = test_client.patch(
            "/api/v1/users/testuser", json={"mail": "newemail@example.com"}, headers=auth_headers
        )
    ...
    def test_update_user_not_found(self, test_client, auth_headers, mock_user_repository):
        ...
        response = test_client.patch(
            "/api/v1/users/nonexistent", json={"mail": "test@example.com"}, headers=auth_headers
        )
    ...
    def test_update_user_unauthorized(self, test_client):
        ...
        response = test_client.patch("/api/v1/users/testuser", json={"mail": "test@example.com"})
...
class TestDeleteUser:
    ...
    def test_delete_user_success(self, test_client, auth_headers, mock_user_repository, mock_user_entry):
